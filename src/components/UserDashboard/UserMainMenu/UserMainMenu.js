                ...
                <div className={classes.description}>
                    <div  >
                        <div className="grid-x grid-padding-x">
                         ...
                         <div className="grid-x grid-padding-x">
                                <div className="cell small-3  medium-3 large-3"><p className={classes.mar}>&#9733;4.2</p></div>
                                <div className="show-for-small-only cell small-6 text-center  medium-6 large-6"><p className={classes.mar}style={{fontSize:'11px'}}>31&#45;MINS</p></div>
                                <div className="hide-for-small-only cell small-6 text-center medium-6 large-6"><p className={classes.mar}>31&#45;MINS</p></div>
                                <div className="cell small-3  medium-3 large-3"><p  className={classes.mar}>&#8377;350</p></div>
                         </div>
